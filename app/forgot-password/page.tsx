        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Email sent</h2>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                If <span className="font-medium text-slate-700 dark:text-slate-300">{email}</span> has an account, you&apos;ll receive a password reset link shortly.
              </p>
